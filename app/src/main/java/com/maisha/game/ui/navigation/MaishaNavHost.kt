    ...
    NavHost(
        ...
        composable(
            ...
            LifeScreen(
                ...
                onPetDismissed = viewModel::onPetDismissed,
                onPetCare = viewModel::onPetCare,
                ...
                onSeekFriendship = viewModel::onSeekFriendship,
                ...
                onEnrollInUniversity = viewModel::onEnrollInUniversity,
                onCampusJob = viewModel::onCampusJob,
                onUniversityInternship = viewModel::onUniversityInternship,
                onRepayStudentLoan = viewModel::onRepayStudentLoan,
                onStartCareerTrack = viewModel::onStartCareerTrack,
                onPracticeCareerTrack = viewModel::onPracticeCareerTrack,
                onTrainTalent = viewModel::onTrainTalent,
                onSignEndorsement = viewModel::onSignEndorsement,
                onDropEndorsement = viewModel::onDropEndorsement,
                onLeaveCareerTrack = viewModel::onLeaveCareerTrack,
